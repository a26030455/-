...
var _boy = ["陳翰威", "詹宗憲", "鄭有城", "吳鈞哲", "黃任杰", "尹維增", "邱振溢", "呂志桓", "丁作文", "陳家富", "李維仁", "洪偉捷", "鄭榮葳", "陳俊龍", "簡宇陽", "曾羿傑"];
var _girl = ["游毓婉", "李培琴", "李曉雯", "何致玫", "駱姝妍", "洪以涵", "林依穎", "黃淑婷"
             , "游玉蓉", "黃淑梅", "賴宛螢", "徐惠玲", "葉芷琳", "賴玫岑", "沈姵嫻", "沈名晏", "廖佳珍", "林宜慧", "連珮芸"];
